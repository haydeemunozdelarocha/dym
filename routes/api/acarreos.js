...
router.post('/recibos/resumen', function(req, res, next ){
  ...
  db.query(recibosDia, function(err, recibos){
    ...
    if(err) throw err;
        ...
        res.render('recibosresumen',{recibos:recibos[0],acarreos:recibos[1],fecha:hora_recibo,total:recibos[2], message: ''})
        }
    }
  });
})
