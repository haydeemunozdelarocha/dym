...
router.get('/estimaciones/acarreos/:estimacionid/:conceptoid', isLoggedIn, function(req,res,err){
  var usuario = req.user;
  var estimacion = req.params.estimacionid;
    var concepto_id = req.params.conceptoid;
...
var obra_id = req.params.obraid;
  ...
  var date = new Date();
  var fecha= moment.tz(date,timezone).format("YYYY-MM-DD");
  var obra_id = req.params.obraid;
